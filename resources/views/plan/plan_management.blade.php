        ...
        <div class="m-[30px]">
            ...
            <div class="overflow-x-auto">
                <table class="table-auto border-collapse border border-gray-300 w-full mt-3 rounded-[20px] overflow-hidden">
                    <thead>
                        <tr>
                            <th class="w-[70%] border border-gray-300 p-4 text-left bg-gray-200">Plan Name</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white">
                            <td class="border border-gray-300 p-4">{{$plan->name}}</td>
