...
<x-app>
    ...
    <h1 class="text-3xl font-bold text-center mb-8">Books Management</h1>

    <div class="m-[30px]">
        <div class="flex justify-end mt-3">
            <a href="{{ route('shop.create') }}" class="w-[130px] inline-flex justify-center items-center px-3 py-2 text-sm font-medium hover:text-[#f09224] text-white hover:bg-white rounded-lg bg-black focus:ring-4 focus:outline-none focus:ring-orange-300">+ Create a new book</a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="table-auto border-collapse border border-gray-300 w-full mt-3 rounded-[20px] overflow-hidden">
                ...
                <tbody>
                    ...
                    <tr class="bg-white">
                        <td class="border border-gray-300 p-4">{{$book->title}}</td>
